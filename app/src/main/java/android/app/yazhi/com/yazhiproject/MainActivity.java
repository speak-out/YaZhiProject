...
import android.app.yazhi.com.yazhiproject.module.MainFragmentAdapter;
import android.app.yazhi.com.yazhiproject.module.home.fragment.HomeFragment;
import android.app.yazhi.com.yazhiproject.module.my.fragment.MyFragment;
import android.app.yazhi.com.yazhiproject.module.yazhi.fragment.YaZhiFragment;
...
public class MainActivity extends BaseActivity {
    ...
    private YaZhiFragment yaZhiFragment;
    ...
    private void initView() {
        if(mFragments == null || mFragments.size() == 0) {
            ...
            homeFragment = HomeFragment.getInstance(null,this);
            mFragments.add(homeFragment);
            yaZhiFragment = YaZhiFragment.getmInstance(null,this);
            mFragments.add(yaZhiFragment);
            myFragment = MyFragment.getmInstance(null,this);
